...
function parser() {
	...
	for (var i = 0; i < objets.length; i++) {
		...
		else if (_obj.type == "model") {
			var url = params.url || "";
			//var model = creerModel(url);
			//enregistrerDansAnnuaire(nom,model);
		}
